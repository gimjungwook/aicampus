...
const featureHighlights = [
  {
    icon: Target,
    title: '업무 결과에 직결',
    description: '“보고서 초안 5분”, “엑셀 반복작업 0회”처럼 즉시 체감할 변화에 맞춘 커리큘럼',
  },
  {
    icon: BookOpen,
    title: '실습 퍼스트',
  ...
  },
  {
    icon: ShieldCheck,
    title: '보안·정책 가이드',
    description: '회사 정책을 고려한 안전한 프롬프트 예시와 데이터 취급 가이드를 함께 제공합니다',
  },
]
...
const samples = [
  ...
  },
  {
    ...
    description: '메일 요약, 회의록 정리, 엑셀 변환 등 바로 복사해 쓸 수 있는 템플릿.',
    cta: '프롬프트 보기',
    href: '/sandbox',
    icon: Lightbulb,
  },
...
const howItWorks = [
  ...
  },
  {
    ...
    title: '업무별 미션 수행',
    description: '레슨마다 “보고서 초안”, “자동화 스크립트” 등 결과물을 완성합니다.',
  },
  {
    icon: BarChart2,
    title: '성과 확인 & 확장',
    description: '실제 업무에 적용 후 시간을 얼마나 줄였는지 기록하고 공유합니다.',
  },
]
    ...
    <div className="flex min-h-screen flex-col">
      ...
      <main className="flex-1">
          ...
          <div className="mx-auto flex max-w-6xl flex-col gap-12 px-4 lg:flex-row lg:items-center lg:gap-16">
            <div className="flex-1 space-y-6 text-center lg:text-left">
              ...
              <p className="text-lg text-muted-foreground sm:text-xl">
                ...
                첫 5분 안에 AI가 내 일에 도움 된다는 확신을 드립니다.
              </p>
        ...
        <section className="border-y bg-muted/30 py-14 lg:py-20">
          <div className="mx-auto flex max-w-6xl flex-col gap-10 px-4 lg:flex-row lg:items-center lg:justify-between">
            <div className="space-y-3 text-center lg:text-left">
              <p className="text-sm font-semibold text-primary">데이터로 확인하는 효용</p>
              <h2 className="text-2xl font-bold sm:text-3xl">체험 후 바로 적용되는 AI 학습</h2>
              <p className="text-muted-foreground">
                단순한 “시연”이 아니라, 실제 업무 시간을 줄인 사용자들의 결과를 수집해 반영하고 있습니다.
              </p>
            </div>
        ...
        <section className="py-16 lg:py-20">
          <div className="mx-auto max-w-6xl px-4">
            <div className="mb-10 text-center">
              <p className="text-sm font-semibold text-primary">왜 AI Campus인가요?</p>
              <h2 className="text-2xl font-bold sm:text-3xl">업무에 바로 맞춘 실습 경험</h2>
            </div>
        ...
        <section className="border-y bg-muted/30 py-16 lg:py-20">
          <div className="mx-auto max-w-6xl px-4">
            <div className="mb-10 flex flex-col gap-4 text-center">
              <p className="text-sm font-semibold text-primary">스크롤 없이 바로 체험</p>
              <h2 className="text-2xl font-bold sm:text-3xl">미리보기와 샌드박스 맛보기</h2>
              <p className="text-muted-foreground">
        ...
        <section className="py-16 lg:py-20">
          <div className="mx-auto max-w-6xl px-4">
            <div className="mb-10 text-center">
              <p className="text-sm font-semibold text-primary">3단계로 끝내는 적용</p>
              <h2 className="text-2xl font-bold sm:text-3xl">클릭 몇 번이면 충분해요</h2>
            </div>
            <div className="grid gap-6 md:grid-cols-3">
        ...
        <section className="border-t py-16 lg:py-24">
          <div className="mx-auto max-w-4xl px-4 text-center">
            ...
            <p className="mb-8 text-muted-foreground">
              샌드박스에서 준비된 프롬프트로 결과를 확인하고, 마음에 들면 코스를 이어가세요.
            </p>
            <div className="flex flex-col items-center justify-center gap-3 sm:flex-row">
              ...
              <Link href="/courses">
                <Button variant="outline" size="lg">코스 보기</Button>
              </Link>
            </div>
          </div>
        </section>
